...
describe("출력 클래스 테스트", () => {
    ...
    describe("구입 개수 출력 테스트", () => {
        test("1. 구입 개수가 정상적으로 출력되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('개를 구매했습니다.'));
        });
    });
    ...
    describe("당첨 통계 출력 테스트", () => {
        test("1. 당첨 통계 헤더가 정상적으로 출력되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('당첨 통계'));
        ...
        test("2. 당첨 통계 결과가 정상적으로 출력되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('3개 일치'));
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('5,000원'));
        ...
        test("3. 보너스 볼 일치 통계가 정상적으로 출력되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('5개 일치, 보너스 볼 일치'));
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('30,000,000원'));
        });
    });
    ...
    describe("수익률 출력 테스트", () => {
        test("1. 수익률이 정상적으로 출력되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('총 수익률은'));
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('62.5%'));
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('입니다.'));
        });
    ...
    describe("에러 출력 테스트", () => {
        test("1. WoowaError를 출력 시 ERROR_PREFIX가 포함되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining(ERROR_PREFIX));
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('테스트 에러'));
        });
        ...
        test("2. 일반 Error를 출력 시 ERROR_PREFIX가 추가되는지 확인한다.", () => {
            ...
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining(ERROR_PREFIX));
            expect(mockPrint).toHaveBeenCalledWith(expect.stringContaining('일반 에러'));
        });
    });
